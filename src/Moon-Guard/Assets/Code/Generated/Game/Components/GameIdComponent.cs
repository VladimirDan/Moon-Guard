...
public partial class GameEntity {
    ...
    public Code.Gameplay.Id id { get { return (Code.Gameplay.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public GameEntity AddId(int newValue) {
        ...
        var component = (Code.Gameplay.Id)CreateComponent(index, typeof(Code.Gameplay.Id));
